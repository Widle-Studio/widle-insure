...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "estimated_damage_cost", sa.Numeric(precision=10, scale=2), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_claims_claim_number"), "claims", ["claim_number"], unique=True
    )
    op.create_index(
        op.f("ix_claims_policy_number"), "claims", ["policy_number"], unique=False
    )
