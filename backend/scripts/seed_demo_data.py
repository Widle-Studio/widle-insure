...
locations = [
    ...
    "789 Pine Ln, Denver, CO",
    "101 Elm Blvd, Seattle, WA",
    "202 Maple Dr, Miami, FL",
    "303 Cedar Ct, Boston, MA",
    "404 Walnut Way, Atlanta, GA",
    "505 Birch St, Phoenix, AZ",
    "606 Ash Ave, Chicago, IL",
    "707 Cherry Ln, Dallas, TX",
    "808 Poplar Blvd, San Diego, CA",
    "909 Spruce Dr, Portland, OR",
    "Intersection of 5th and Broadway, New York, NY",
    "I-95 Northbound near Exit 45",
    "Parking lot at 1000 Commercial Pkwy",
]
descriptions = [
    "Rear-ended at a stoplight by a distracted driver.",
    "Backed into a pole in a parking garage.",
    "Swiped on the passenger side while parked on the street overnight.",
    "Hit a deer on a rural highway.",
    "T-boned at an intersection by a car running a red light.",
    "Hail damage from severe thunderstorm.",
    "Windshield cracked by a rock kicked up by a truck.",
    "Vandalism: key scratch along the driver's side.",
    "Sideswiped by another vehicle merging onto the freeway.",
    "Front bumper damaged from hitting a high curb.",
]
        ...
        try:
            ...
            for i in range(50):
                ...
                if status_roll < 0.4:
                    status = "Approved"
                    damage_cost = round(
                        random.uniform(500, 1900), 2
                    )  # Auto-approvals usually < $2000
                ...
                created_at = incident_date + timedelta(
                    days=random.randint(0, 3)
                )  # Reported 0-3 days later
                ...
                ai_analysis = {
                    ...
                    "damaged_parts": ["front_bumper", "headlight"]
                    if "front" in claim.incident_description.lower()
                    else ["rear_bumper"],
                    "red_flags": ["Delayed reporting"]
                    if (created_at - incident_date).days > 30
                    else [],
                }
